...
<div class="heading">
   <h3>Seus Pedidos</h3>
   <p> <a href="index.php">Início</a> / pedidos </p>
</div>
...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <?php
         $order_query = mysqli_query($conn, "SELECT * FROM `orders` WHERE user_id = '$user_id'") or die('consulta falhou');
      ...
      <div class="box">
         ...
         <p> total preço : <span>R$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
